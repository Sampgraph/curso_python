...
class CategoriaDAO:
    tabela_categorias = []  # Atributo de classe representando a tabela de Categorias.
    ...
    def update(self, id: int, categoria: Categoria):
        for index, categoria in enumerate(CategoriaDAO.tabela_categorias):
            if categoria.id == id:
                CategoriaDAO.tabela_categorias[index] = categoria
                return
    ...
    def is_empty(self) -> bool:
        return len(CategoriaDAO.tabela_categorias) == 0
